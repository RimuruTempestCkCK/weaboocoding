...
function Footer() {
  return (
    <>
      <footer>
        <div className="footer-grid">
          <div className="footer-brand">
            <div className="nav-logo-text" style={{ display: 'block', marginBottom: '.8rem' }}>
          ...
          <div className="footer-col">
            <h4>Kontak</h4>
            <ul>
              <li><a href="https://wa.me/6285157558469" onClick={() => track('Klik_WA')}>WhatsApp</a></li>
              <li><a href="https://instagram.com/weaboocoding">Instagram</a></li>
            </ul>
          </div>
        </div>
      ...
      {/*  FLOATING WA BUTTON  */}
      <a href="https://wa.me/6285157558469" onClick={() => track('Klik_WA')} className="float-wa" target="_blank" aria-label="Chat WhatsApp" rel="noreferrer">
