...
function JasaPembuatanWebsite() {
  useSEO({
    title: `Jasa Pembuatan Website di Tangerang Selatan | WeabooCoding`,
    description: `WeabooCoding melayani jasa pembuatan website profesional untuk company profile, toko online, UMKM, dan perusahaan di Tangerang Selatan.`,
    schema: ``
  });
  ...
  <section style={{ padding: '150px 5% 100px', maxWidth: '800px', margin: 'auto' }}>
    <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Jasa Pembuatan Website Profesional</h1>
    <p style={{ fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '20px' }}>
      WeabooCoding melayani jasa pembuatan website profesional untuk company profile, toko online, UMKM, dan perusahaan di Tangerang Selatan. WeabooCoding hadir sebagai solusi terpercaya untuk Anda yang membutuhkan layanan ini, khususnya di wilayah Tangerang Selatan dan seluruh Indonesia secara online.
    </p>
...
export default JasaPembuatanWebsite;
