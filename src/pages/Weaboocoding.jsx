...
<section className="hero" id="home">
  <div className="hero-content">
    ...
    <h1 className="hero-title">Solusi Jasa Coding &amp;<br /><span className="accent">Website Profesional</span></h1>
    ...
    <div className="hero-stats">
      ...
      <div className="stat"><div className="stat-num">150+</div><div className="stat-label">Klien Puas</div></div>
...
<section className="about" id="about">
  <div className="about-grid">
    ...
    <div className="reveal reveal-right">
      ...
      <p style={{ color: 'var(--gray-600)', lineHeight: '1.8', marginBottom: '2rem' }}>WeabooCoding adalah tim developer berpengalaman yang berfokus pada jasa coding, tutorial, dan solve code. Kami hadir untuk membantu mahasiswa, startup, dan UMKM mewujudkan proyek digitalnya.</p>
...
<section className="portfolio" id="portfolio">
  ...
  <div className="portfolio-grid">
    <div className="portfolio-card reveal reveal-zoom">
      <div className="p-thumb p-thumb-1">🛒</div>
      <div className="p-body">
        <div className="p-tag">E-Commerce</div>
        <div className="p-name">TokoBaju Online</div>
        <p className="p-desc">Platform toko online lengkap dengan payment gateway & dashboard admin.</p>
      </div>
    </div>
    <div className="portfolio-card reveal reveal-zoom">
      <div className="p-thumb p-thumb-2">🏥</div>
      <div className="p-body">
        <div className="p-tag">Web App</div>
        <div className="p-name">Sistem Klinik Digital</div>
        <p className="p-desc">Manajemen rekam medis, jadwal dokter, dan antrian pasien berbasis web.</p>
      </div>
    </div>
    <div className="portfolio-card reveal reveal-zoom">
      <div className="p-thumb p-thumb-3">📱</div>
      <div className="p-body">
        <div className="p-tag">Android App</div>
        <div className="p-name">AplikasiAbsen GPS</div>
        <p className="p-desc">Absensi pegawai berbasis lokasi GPS dengan laporan real-time.</p>
      </div>
    </div>
    <div className="portfolio-card reveal reveal-zoom">
      <div className="p-thumb p-thumb-4">🎓</div>
      <div className="p-body">
        <div className="p-tag">Tugas Kuliah</div>
        <div className="p-name">Sistem Informasi Skripsi</div>
        <p className="p-desc">Aplikasi manajemen skripsi mahasiswa untuk universitas swasta di Jakarta.</p>
      </div>
    </div>
    <div className="portfolio-card reveal reveal-zoom">
      <div className="p-thumb p-thumb-5">🍔</div>
      <div className="p-body">
        <div className="p-tag">Landing Page</div>
        <div className="p-name">FoodBoss Restaurant</div>
        <p className="p-desc">Website restoran modern dengan fitur reservasi meja dan menu digital.</p>
      </div>
    </div>
    <div className="portfolio-card reveal reveal-zoom">
      <div className="p-thumb p-thumb-6">📊</div>
      <div className="p-body">
        <div className="p-tag">Dashboard</div>
        <div className="p-name">Analytics Dashboard</div>
        <p className="p-desc">Dashboard monitoring data penjualan dengan visualisasi chart interaktif.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="why">
  <div className="section-header centered">
    ...
    <p className="section-sub">Kami memberikan nilai lebih dari sekadar kode—kami memberikan solusi terbaik untuk bisnismu.</p>
  </div>
...
<section className="testimonials" id="testimoni">
  <div className="section-header centered">
    ...
    <p className="section-sub">Kepuasan klien adalah prioritas utama kami. Ini yang mereka katakan.</p>
  </div>
    ...
    <div className="testi-track">
      <div className="testi-group">
        ...
        <div className="testi-card">
          ...
          <p className="testi-text">"WeabooCoding benar-benar profesional! Website toko online saya selesai tepat waktu dan hasilnya melampaui ekspektasi. Sangat recommended!"</p>
          <div className="testi-author">
            <div className="avatar av1">AR</div>
            <div>
              <div className="author-name">Andi Rahmat</div>
              <div className="author-role">Owner TokoBaju Online</div>
            </div>
          </div>
        </div>
        {/*  Card 2  */}
        <div className="testi-card">
          <div className="stars">★★★★★</div>
          <p className="testi-text">"Tugas skripsi saya hampir deadline dan WeabooCoding berhasil bantu selesaikan dalam waktu singkat. Kode rapi, bersih, dan bisa dipahami dengan baik!"</p>
          <div className="testi-author">
            <div className="avatar av2">SR</div>
            <div>
              <div className="author-name">Sari Rahayu</div>
              <div className="author-role">Mahasiswi Informatika</div>
            </div>
          </div>
        </div>
        {/*  Card 3  */}
        <div className="testi-card">
          <div className="stars">★★★★★</div>
          <p className="testi-text">"Harga sangat terjangkau untuk kualitas yang didapat. Tim responsif dan komunikatif. Sudah 3x order dan selalu puas dengan hasilnya!"</p>
          <div className="testi-author">
            <div className="avatar av3">BW</div>
            <div>
              <div className="author-name">Budi Wijaya</div>
              <div className="author-role">CEO Startup Fintech</div>
            </div>
          </div>
        </div>
        {/*  Card 4  */}
        <div className="testi-card">
          <div className="stars">★★★★★</div>
          <p className="testi-text">"Aplikasi Android untuk bisnis laundry saya jalan dengan sempurna. Bug yang sempat muncul langsung ditangani dengan cepat. Top service!"</p>
          <div className="testi-author">
            <div className="avatar av4">DN</div>
            <div>
              <div className="author-name">Dian Novita</div>
              <div className="author-role">Pemilik Laundry Express</div>
            </div>
          </div>
        </div>
        {/*  Card 5  */}
        <div className="testi-card">
          <div className="stars">★★★★★</div>
          <p className="testi-text">"Konsultasi gratis yang ditawarkan sangat membantu saya memahami kebutuhan project. Hasilnya pun sangat memuaskan. Wajib dicoba!"</p>
          <div className="testi-author">
            <div className="avatar av5">RP</div>
            <div>
              <div className="author-name">Rizky Pratama</div>
              <div className="author-role">Freelancer Digital</div>
            </div>
          </div>
        </div>
        {/*  Card 6  */}
        <div className="testi-card">
          <div className="stars">★★★★★</div>
          <p className="testi-text">"Dashboard analitik yang mereka buat sangat intuitif and powerful. Data bisnis saya kini mudah dipantau secara real-time. Luar biasa!"</p>
          <div className="testi-author">
            <div className="avatar av6">MS</div>
            <div>
              <div className="author-name">Maya Sari</div>
              <div className="author-role">Manajer Marketing UMKM</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <div className="contact-grid">
    <div className="reveal reveal-left">
      ...
      <div className="contact-links">
        <a href="https://wa.me/62xxxxxxxxxx" className="contact-link" target="_blank">
          <span className="icon">💬</span> WhatsApp: +62 xxx-xxxx-xxxx
        </a>
        <a href="https://instagram.com/weaboocoding" className="contact-link" target="_blank">
          <span className="icon">📸</span> @weaboocoding
        </a>
      </div>
      <a href="https://wa.me/62xxxxxxxxxx" className="btn-wa" target="_blank" style={{ marginTop: '1.5rem', display: 'inline-flex' }}>
