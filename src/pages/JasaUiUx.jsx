...
function JasaUiUx() {
  useSEO({
    title: `Jasa Desain UI/UX & Figma | WeabooCoding`,
    description: `Tingkatkan user experience dengan jasa desain UI/UX dari WeabooCoding. Prototipe interaktif dengan Figma untuk aplikasi dan website.`,
    schema: ``
  });
  ...
  <section style={{ padding: '150px 5% 100px', maxWidth: '800px', margin: 'auto' }}>
    <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Jasa Desain UI/UX Modern</h1>
    <p style={{ fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '20px' }}>
      Tingkatkan user experience dengan jasa desain UI/UX dari WeabooCoding. Prototipe interaktif dengan Figma untuk aplikasi dan website. WeabooCoding hadir sebagai solusi terpercaya untuk Anda yang membutuhkan layanan ini, khususnya di wilayah Tangerang Selatan dan seluruh Indonesia secara online.
    </p>
