...
function JasaPembuatanAplikasi() {
  useSEO({
    title: `Jasa Pembuatan Aplikasi Android & Web | WeabooCoding`,
    description: `Jasa pembuatan aplikasi Android, iOS, dan Web app custom oleh WeabooCoding. Solusi digital terbaik untuk bisnis Anda di Tangerang Selatan.`,
    schema: ``
  });
  ...
  <section style={{ padding: '150px 5% 100px', maxWidth: '800px', margin: 'auto' }}>
    <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Jasa Pembuatan Aplikasi Custom</h1>
    <p style={{ fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '20px' }}>
      Jasa pembuatan aplikasi Android, iOS, dan Web app custom oleh WeabooCoding. Solusi digital terbaik untuk bisnis Anda di Tangerang Selatan. WeabooCoding hadir sebagai solusi terpercaya untuk Anda yang membutuhkan layanan ini, khususnya di wilayah Tangerang Selatan dan seluruh Indonesia secara online.
    </p>
...
export default JasaPembuatanAplikasi;
