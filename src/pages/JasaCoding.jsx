...
function JasaCoding() {
  useSEO({
    title: `Jasa Coding & Bantuan Tugas Pemrograman | WeabooCoding`,
    description: `Butuh jasa coding? WeabooCoding melayani pengerjaan proyek, debug, dan penyelesaian tugas coding untuk mahasiswa dan perusahaan.`,
    schema: ``
  });
  ...
  <section style={{ padding: '150px 5% 100px', maxWidth: '800px', margin: 'auto' }}>
    <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Jasa Coding Profesional & Mahasiswa</h1>
    <p style={{ fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '20px' }}>
      Butuh jasa coding? WeabooCoding melayani pengerjaan proyek, debug, dan penyelesaian tugas coding untuk mahasiswa dan perusahaan. WeabooCoding hadir sebagai solusi terpercaya untuk Anda yang membutuhkan layanan ini, khususnya di wilayah Tangerang Selatan dan seluruh Indonesia secara online.
    </p>
